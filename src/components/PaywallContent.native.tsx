...
/**
 * RevenueCat dashboard paywall (templates / Paywalls v2). Requires a development build with native modules.
 */
    ...
    return (
      <View style={styles.box}>
        ...
        <Text style={styles.body}>
          Expo Go does not include RevenueCat native modules. Install a development build (e.g. `npx expo run:android` or EAS
          development profile), then use `npm run start:dev`.
        </Text>
